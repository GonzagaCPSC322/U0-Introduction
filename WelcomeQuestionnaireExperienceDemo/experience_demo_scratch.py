...
infile = open("322_welcome_questionnaire_demo.csv", "r")
...
# create a figure with 4 axes all in a row
fig, ax = plt.subplots(1, 4, sharex=True, sharey=True) # one row, four columns
...
plt.tight_layout()
plt.savefig("322_experience.png")
